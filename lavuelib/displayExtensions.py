...
class HandleWithSignals(Handle):
    ...
    """
    #: (:class:`PyQt5.QtCore.pyqtSignal`) hover event emitted
    ...
    def hoverEvent(self, ev):
        ...
        :type ev: :class:`PyQt5.QtCore.QEvent`:
        """
...
class ROIExtension(DisplayExtension):
    ...
    def __init__(self, parent=None):
        ...
        #: (:class:`PyQt5.QtCore.QSignalMapper`) current roi mapper
        self.__currentroimapper = QtCore.QSignalMapper(self)
        #: (:class:`PyQt5.QtCore.QSignalMapper`) roi region mapper
...
class CutExtension(DisplayExtension):
    ...
    def __init__(self, parent=None):
        ...
        #: (:class:`PyQt5.QtCore.QSignalMapper`) current cut mapper
        self.__currentcutmapper = QtCore.QSignalMapper(self)
        #: (:class:`PyQt5.QtCore.QSignalMapper`) cut region mapper
