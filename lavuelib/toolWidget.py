...
twproperties = [
    {'sname': 'intensity', 'widget': 'IntensityToolWidget',
     'name': 'Intensity', 'requires': ()},
    {'sname': 'roi', 'widget': 'ROIToolWidget',
     'name': 'ROI', 'requires': ()},
    {'sname': 'linecut', 'widget': 'LineCutToolWidget',
     'name': 'LineCut', 'requires': ()},
    {'sname': 'angle/q', 'widget': 'AngleQToolWidget',
     'name': 'Angle/Q', 'requires': ()},
    {'sname': 'movemotors', 'widget': 'MotorsToolWidget',
     'name': 'MoveMotors', 'requires': ("PYTANGO",)},
    {'sname': 'meshscan', 'widget': 'MeshToolWidget',
     'name': 'MeshScan', 'requires': ("PYTANGO",)},
    {'sname': '1d-plot', 'widget': 'OneDToolWidget',
     'name': '1d-Plot', 'requires': ()},
    {'sname': 'projections', 'widget': 'ProjectionToolWidget',
     'name': 'Projections', 'requires': ()},
    {'sname': 'maxima', 'widget': 'MaximaToolWidget',
     'name': 'Maxima', 'requires': ()},
    {'sname': 'QROIProj', 'widget': 'QROIProjToolWidget',
