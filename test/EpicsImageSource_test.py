...
# test fixture
class EpicsImageSourceTest(unittest.TestCase):
...
#        self.__seed = 332115341842367128541506422124286219441
        ...
        print("Epics faked: %s" % epicsfake.faked)
    ...
    def takeNewImage(self):
        ...
        epics.filename = fname
        print("SET: %s" % epics.filename)
    ...
    def test_readimage_fromstart(self):
        ...
        options = argparse.Namespace(
            mode='expert',
            source='epicspv',
            configuration='00SIM0:cam1:,[487,195]',
            start=True,
            # levels="0,1000",
            tool='intensity',
            transformation='none',
