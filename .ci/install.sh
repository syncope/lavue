...
if [ "$1" = "debian11" ]  || [ "$1" = "debian12" ]  || [ "$1" = "debian11pg013" ]; then
...
if [ "$2" = "2" ]; then
    ...
    if [ "$1" = "debian10" ] || [ "$1" = "ubuntu20.04" ] || [ "$1" = "ubuntu20.10" ] || [ "$1" = "ubuntu21.04" ] || [ "$1" = "ubuntu21.10" ] || [ "$1" = "ubuntu22.04" ]  || [ "$1" = "ubuntu22.10" ] || [ "$1" = "ubuntu23.10" ] || [ "$1" = "debian11" ] || [ "$1" = "debian12" ] ; then
